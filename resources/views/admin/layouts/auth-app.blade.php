                        ...
                        <div class="row">
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-check-primary form-check-inline">
                                        ...
                                        <label class="form-check-label" for="form-check-default">
                                            I agree the <a href="/adminjavascript:void(0);" class="text-primary">Terms and Conditions</a>
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="text-center">
                                    <p class="mb-0">Already have an account ? <a href="/adminjavascript:void(0);" class="text-warning">Sign in</a></p>
                                </div>
                            </div>
