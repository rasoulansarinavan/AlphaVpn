    ...
    <table id="invoice-list" class="table dt-table-hover" style="width:100%">
            ...
            <td>
                <div class="d-flex">
                    <div class="usr-img-frame me-2 rounded-circle">
                        <img alt="avatar" class="img-fluid rounded-circle" src="/admin/src/assets/img/profile-12.jpeg">
                    </div>
        ...
        <tr>
            ...
            <td>
                <div class="d-flex">
                    <div class="usr-img-frame me-2 rounded-circle">
                        <img alt="avatar" class="img-fluid rounded-circle" src="/admin/src/assets/img/profile-11.jpeg">
                    </div>
        ...
        <tr>
            ...
            <td>
                <div class="d-flex">
                    <div class="usr-img-frame me-2 rounded-circle">
                        <img alt="avatar" class="img-fluid rounded-circle" src="/admin/src/assets/img/profile-4.jpeg">
                    </div>
        ...
        <tr>
            ...
            <td>
                <div class="d-flex">
                    <div class="usr-img-frame me-2 rounded-circle">
                        <img alt="avatar" class="img-fluid rounded-circle" src="/admin/src/assets/img/profile-9.jpeg">
                    </div>
