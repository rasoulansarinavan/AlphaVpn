    ...
    <div class="middle-content container-xxl p-0">
        ...
        <div class="row layout-spacing ">
            ...
            <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 layout-top-spacing">
                ...
                <div class="widget-content widget-content-area widget widget-card-five text-center"
                    ...
                    <div class="user-info-list">
                        ...
                        <div class="info">
                                ...
                                @if($wallet)
                                    ...
                                    <div class="d-flex w-100">
                                        ...
                                        <div class="billing-edit align-self-center ms-auto">
                                            <button type="button" name="editWallet"
                            ...
                            <form
                                ...
                                <button type="submit" class="btn btn-secondary mt-4 add-payment">
                                    @if(isset($wallet->address_wallet))
                                        Edit
                                    @else
                                        Save
                                    @endif
